...
@section('content')
    <h3 class="text-3xl font-medium text-gray-700">Roles</h3>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    @foreach ($role->permissions as $permission)
                                        <span
                                            class="inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-white bg-indigo-500 rounded-full">{{ $permission->name }}</span>
                                    @endforeach
                                </td>

                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <div class="text-sm leading-5 text-gray-500">{{ $role->users()->count() }}</div>
                                </td>
