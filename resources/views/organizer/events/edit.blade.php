...
<div class="bg-white dark:bg-gray-800 relative  shadow-md sm:rounded-lg overflow-hidden">
    <div class="relative p-4 bg-white rounded-lg shadow  dark:bg-gray-800 sm:p-5">
        ...
        <!-- Modal body -->
        <form action="{{ route('organizer.events.update',$event->id) }}" method="POST" enctype="multipart/form-data" id="createEventForm">
            @csrf
            @method('put')
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title"
                        ...
                        placeholder="Title" required="" value="{{$event->title}}">
                ...
                <div>
                    ...
                    <input type="number" name="capacity" id="places_available" value="{{$event->capacity}}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500"
                ...
                <div>
                    ...
                    <select name="reservation_approval_mode" id="reservation_approval_mode"
                        ...
                        <option value="manual" @if ($event->reservation_approval_mode == 'manual')
                            selected  
                        @endif>Manual</option>
                        <option value="automatic" @if ($event->reservation_approval_mode == 'automatic')
                            selected
