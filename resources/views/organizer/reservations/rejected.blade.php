...
@section('content')
    ...
    <div class="mt-8">
        ...
        <a href="{{ route('reservations.paid') }}"
            class="px-4 py-2 text-sm font-medium leading-5 text-white bg-green-600 border border-transparent rounded-md hover:bg-green-500 focus:outline-none focus:border-green-700 focus:shadow-outline-green active:bg-green-700 transition duration-150 ease-in-out">Paid</a>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 w-15 h-18">
                                            <img class="w-10 h-10"
                                                src=" {{ asset('events/' . $reservation->event->image) }} " alt="">
                                        </div>
