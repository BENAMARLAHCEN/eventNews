...
<body>
    <div class="cardWrap">
        <div class="card cardLeft">
            ...
            <div class="seat">
                <h2>{{$reservation->event->capacity}}</h2>
                <span>seat</span>
            </div>
            <div class="time">
                <h2>{{ \Carbon\Carbon::parse($reservation->event->date)->format('d M, Y') }},<p>{{ \Carbon\Carbon::parse($reservation->event->date)->format('h:i') }}</p> </h2>
                <span>time</span>
            </div>
